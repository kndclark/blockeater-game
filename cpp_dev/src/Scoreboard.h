...
public:
    ...
    void render(int screen_height, int score, int level, int current_gap_size, int checkpoints_passed, int checkpoints_per_level, int player_size, bool on_cooldown, Uint32 cooldown_remaining) const;
    ...
    void renderDashStatus(int screen_height, bool on_cooldown, Uint32 cooldown_remaining) const;
